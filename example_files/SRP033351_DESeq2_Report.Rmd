...
path.start='/project/bhimeslab/RNASeq/SRP033351/'
...
fav_list <- list()
coldata <- read.table('/project/bhimeslab/RNASeq/SRP033351/files/SRP033351_Phenotype_withQC.txt', sep='\t', header=TRUE)
...
mart <- useMart(biomart='ENSEMBL_MART_ENSEMBL', host='jan2019.archive.ensembl.org', path='/biomart/martservice' ,dataset='hsapiens_gene_ensembl')
...
pathways.msigkegg <- gmtPathways("/project/bhimeslab/pipelines/RNASeq/c2.cp.kegg.v7.4.symbols.gmt")
pathways.msigreactome <- gmtPathways("/project/bhimeslab/pipelines/RNASeq/c2.cp.reactome.v7.4.symbols.gmt")
