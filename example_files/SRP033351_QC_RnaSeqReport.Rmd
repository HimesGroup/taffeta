---
title: 'RNA-Seq Report of Sample QC and Alignment Summary Statistics for Project SRP033351'
...
if (exists("ercc.mixes") & ("1" %in% ercc.mixes | "2" %in% ercc.mixes)) {
	sample.names <- sample.names.orig
...
No feature count (per million reads) statistics from htseq-count quantification results
