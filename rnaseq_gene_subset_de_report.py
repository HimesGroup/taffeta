...
def main(project_name, sample_info_file, path_start, gene_set_name, gene_list_file):
	if path_start == "./":
...
if __name__ == "__main__":
	...
	main(args.project_name, args.samples_in, args.path_start, args.gene_set_name, args.gene_list_file)
